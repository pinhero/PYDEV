                        ...
                        <td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; Margin:0">
                                                ...
                                                <td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#4a4a44">
                                                        <tr>
                                                            ...
                                                            <td valign="top">
                                                                <div style="font-size:0pt; line-height:0pt; height:4px; background:#000; "></div>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#4a4a44">
                                                        <tr>
                                                            <td style="line-height:40pt; text-align:center">
                                                                <div>
                                                                    <span style="font-size:25pt; color:#fff;"> eCEV </span>
                                                                </div>
                                                            </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                <tr>
                                    <td>
                                        <!-- Section 1 -->
                                        <div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#"><img src="https://radiant-headland-46296.herokuapp.com/api/images/bg.jpg" border="0" width="650" height="280" alt="" /></a></div>
                                        <!-- END Section 1 -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="text-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:center">
                                                        Bonjour  {{ $user->firstname }} {{ $user->lastname }}. Vous avez initialisé la réinitialisation de votre compte. Pour définir un nouveau mot de passe veuillez cliquer sur le lien bouton suivant.
                                                    </div>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                        <tr>
                                                            <td height="15" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                                                    ...
                                                    <div class="h2-white-center" style="color:#ffffff; font-family:Arial,sans-serif, 'SSP'; ">
                                                        <div style="font-family:Arial,sans-serif, 'SSP'; font-size:22px; line-height:30px; text-align:center; text-transform:uppercase">
                                                            <a target="_blank" href="{{ $url }}" style="
                                                            background-color:#ffffff; padding:5px; color:#4a4a44; text-decoration:none">
                                                                <span style="color:#4a4a44; text-decoration:none">Réinitialiser mot de passe</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <br />
                                                ...
                                                <td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        <tr>
                                                            <td class="content-spacing" style="font-size:0pt; line-height:0pt; text-align:left" width="30"></td>
                                                            <td>
                                                                <div class="h3" style="color:#4a4a44; font-family:Arial,sans-serif, 'SSP'; font-size:24px; line-height:30px; text-align:left">Découvrez nos services</div>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                                    <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="20">
                                                                            ...
                                                                            <img src="https://radiant-headland-46296.herokuapp.com/api/images/bullet.png" border="0" width="11" height="11" alt="" />
                                                                        </td>
                                                                        <td class="text3" style="color:#55544d; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:left">
                                                                            Expédiez plus vite et gagnez du temps.
                                                                            Avec eCEV trouver un transporteur fiable et digne de confiance en temps réel.
                                                                            Suivez chaque étape en ligne, de la publication de votre offre, à la livraison facilement.
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="text3" style="color:#55544d; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:left">
                                                                            Avec eCEV retrouvez toutes les offres offres variées et adaptées à votre moyen de transport publier chaque jour par des affréteurs fiables.
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="text3" style="color:#55544d; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:left">
                                                                            Ne roulez plus à vide. Grâce à notre plateforme eCEV, retrouvez tous les jours des opportunités de transports peu importe votre position pour combler vos retours de mission vide pour augmenter votre marge de revenue.
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="text-footer-c" style="color:#a0a09a; font-family:Arial,sans-serif, 'SSP'; font-size:12px; line-height:16px; text-align:center">
                                                        Vous recevez ce courriel en raison du compte que vous avez créé sur eCEV.<br />
                                                        Pour toute information, contactez le Support eCEV.
                                                    </div>
                                                    <!-- END Footer Bar text -->
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                        <tr>
